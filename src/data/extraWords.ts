// Palabras comunes (profesiones, en su mayoría) que faltan en
// an-array-of-spanish-words, tomadas de Tuttifrutalo/Enganchalo.
export const EXTRA_WORDS_ES: string[] = [
